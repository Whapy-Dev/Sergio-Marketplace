    ...
    <SafeAreaView className="flex-1 bg-white" edges={['top']}>
      ...
      <ScrollView className="flex-1 px-4 py-6">
        ...
        <Text className="text-base text-gray-700 mb-4 leading-6">
          Al acceder y usar Yo Compro Formosa, aceptas estar sujeto a estos términos y condiciones. Si no estás de acuerdo con alguna parte de estos términos, no debes usar nuestros servicios.
        </Text>
        ...
        <Text className="text-base text-gray-700 mb-4 leading-6">
          Yo Compro Formosa es una plataforma que conecta compradores y vendedores en Formosa, Argentina. Nos reservamos el derecho de modificar o discontinuar el servicio en cualquier momento sin previo aviso.
        </Text>
        ...
        <Text className="text-base text-gray-700 mb-4 leading-6">
          Los vendedores son responsables de la exactitud de las descripciones de sus productos, precios y disponibilidad. Yo Compro Formosa actúa como intermediario y no es responsable de las transacciones entre compradores y vendedores.
        </Text>
        ...
        <Text className="text-base text-gray-700 mb-4 leading-6">
          Todo el contenido de la plataforma, incluyendo textos, gráficos, logos y software, es propiedad de Yo Compro Formosa y está protegido por las leyes de propiedad intelectual.
        </Text>
        ...
        <Text className="text-base text-gray-700 mb-4 leading-6">
          Yo Compro Formosa no será responsable por daños indirectos, incidentales, especiales o consecuentes que resulten del uso o la imposibilidad de usar nuestros servicios.
        </Text>
        ...
        <Text className="text-base text-gray-700 mb-6 leading-6">
          Si tienes preguntas sobre estos términos, contáctanos en soporte@Yo Compro.com
        </Text>

        <View className="bg-gray-50 rounded-lg p-4 mb-6">
          <Text className="text-sm text-gray-600 text-center">
            Al continuar usando Yo Compro Formosa, aceptas estos términos y condiciones
          </Text>
        </View>
      </ScrollView>
    </SafeAreaView>
